...
- Fecha: 12/3/2026, 19:09:14
- Base URL: http://127.0.0.1:3001
- Stamp: 20260313000710-UCBU
...
| PASS | Analyst | Cliente creado | El alta del cliente QA Visual 20260313000710-UCBU se persistió correctamente. | [captura](screenshots/analyst-clients-list.png) |
...
| PASS | Admin | Creación de préstamo | La originación redirige al detalle del préstamo creado para QA Visual 20260313000710-UCBU. | [captura](screenshots/admin-loan-detail.png) |
| PASS | Admin | Préstamo activo | El préstamo PRE-2026-013 queda activo tras la originación. | [captura](screenshots/admin-loan-active.png) |
...
| PASS | Collection | Recibo PDF | El recibo se descarga con nombre legible (recibo-REC-PRE-2026-013-001.pdf) y contenido PDF válido. | [captura](screenshots/collection-receipt-ready.png) |
...
| FAIL | General | Ejecución QA visual | page.waitForURL: Timeout 30000ms exceeded.
=========================== logs ===========================
...
- Cliente: 3c924833-9b6c-41d7-85d6-7f2995541c99
- Solicitud: fbd877d7-df45-4e91-977e-ebd44847b5a5
- Préstamo: 5aacfa32-91b1-4589-badf-777494e450d3
- Pago: bedbfec8-05ff-440e-85e8-75146de69acf
- Promesa: n/a
- Gestión: n/a
- Viewer temporal: c90d21f1-f997-4700-b6c9-49518a87363e
